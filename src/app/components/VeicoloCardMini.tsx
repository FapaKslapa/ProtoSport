...
const VeicoloCardMini: React.FC<VeicoloCardMiniProps> = ({veicolo, selected, onClick}) => (
    <button
        ...
        onClick={onClick}
        className={`
            flex items-center w-full p-3 rounded-xl border-2 mb-2 transition-all duration-200 text-left
    ...
    >
        <div className="relative w-12 h-12 flex-shrink-0 mr-3">
            <Image src="/placeholder.png" alt={`${veicolo.marca} ${veicolo.modello}`} fill
        ...
        <div className="flex-1 min-w-0">
            ...
            <div className="text-xs text-gray-400">{veicolo.targa} {veicolo.anno && `· ${veicolo.anno}`}</div>
        </div>
        {selected && (
